 ...
 *
 */
@Mojo(name = "genbean"/* defaultPhase = LifecyclePhase.PROCESS_SOURCES */)
public class Touch extends AbstractMojo {

	@Parameter(defaultValue = "${project.build.directory}", property = "path", required = true)
	private String path;
